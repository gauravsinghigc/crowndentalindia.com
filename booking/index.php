...
<head>
    ...
    <title><?php echo $name; ?> : Book Appointment</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="patient-content">
                            <p class="patient-tag-line">Dentist Accepting New Appointments</p><!-- /.patient-tag-line -->
                            <br>
                            <p class="patient-text">We want to thank you for visiting the <?php echo $name; ?> website! Our goal is to address your personal dental needs within your budget.</p><!-- /.patient-text -->
                            <br>
                            ...
                            <br>
                            <p class="patient-text">Interested? Complete the form below and we will contact you within 24 hours! Or feel free to call us at Dentallox Office Phone Number <?php echo $phone; ?></p><!-- /.patient-text -->
                            <br><br>
                            ...
                            <br><br>
                            <form action="../booking_send.php" method="POST" class="patient__form contact-form-validated">
                                ...
                                <div class="patient__form-field">
                                    ...
                                    <input type="text" name="date" class="datepicker" placeholder="DD/Month/YYYY">
                                </div><!-- /.patient__form-field -->
                                <div class="patient__form-field">
