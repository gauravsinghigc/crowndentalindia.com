...
<head>
    ...
    <title><?php echo $title; ?> : General Dentistry</title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="inner-banner">
            <div class="container">
                <h2 class="inner-banner__title">General Dentistry</h2><!-- /.inner-banner__title -->
                <ul class="thm-breadcrumb">
                    ...
                    <li class="thm-breadcrumb__item current"><a class="thm-breadcrumb__link" href="../../specialities/general-dentistry/">General Dentistry</a></li>
                </ul><!-- /.thm-breadcrumb -->
            </div><!-- /.container -->
                    ...
                    <div class="col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__image">
                                <img src="<?php echo $url; ?>/images/services/general-dentistry.jpg" alt="General Dentistry" />
                            </div><!-- /.service-details__image -->
                            <h3 class="service-details__title">General Dentistry</h3><!-- /.service-details__title -->
                            <p class="service-details__text">General dentistry related services of the clinic include the following:<br><br>

                                1. A complete oral health consultation<br>

                                2. Cleaning (Scaling) of Teeth using automated scalers<br>

                                3. Polishing of teeth to provide a natural gloss<br>

                                4. Fillings of decayed (Carious) teeth with tooth coloured material.<br>

                                5. Extraction of teeth that cannot be salvaged.<br>
