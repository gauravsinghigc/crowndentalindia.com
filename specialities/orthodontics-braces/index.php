...
<head>
    ...
    <title><?php echo $title; ?> : Orthodontics / Braces</title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="inner-banner">
            <div class="container">
                <h2 class="inner-banner__title">Invisible Braces</h2><!-- /.inner-banner__title -->
                <ul class="thm-breadcrumb">
                    ...
                    <li class="thm-breadcrumb__item current"><a class="thm-breadcrumb__link" href="../../specialities/orthodontics-braces/">Invisible Braces</a></li>
                </ul><!-- /.thm-breadcrumb -->
            </div><!-- /.container -->
