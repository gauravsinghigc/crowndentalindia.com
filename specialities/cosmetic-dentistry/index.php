...
<head>
    ...
    <title><?php echo $title; ?> : Cosmetic Dentistry</title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="inner-banner">
            <div class="container">
                <h2 class="inner-banner__title">Cosmetic Denstistry</h2><!-- /.inner-banner__title -->
                <ul class="thm-breadcrumb">
                    ...
                    <li class="thm-breadcrumb__item current"><a class="thm-breadcrumb__link" href="../../specialities/cosmetic-dentistry/">Cosmetic Dentistry</a></li>
                </ul><!-- /.thm-breadcrumb -->
            </div><!-- /.container -->
                        ...
                        <div class="service-sidebar">
                            ...
                            <div class="service-sidebar__single">
                                <div class="service-sidebar__contact">
                                    <p class="service-sidebar__contact-text"><i class="fa fa-phone"></i><a href="teL:<?php echo $phone; ?>" class="service-sidebar__contact-highlight"><?php echo $phone; ?></a></p><!-- /.service-sidebar__contact-text -->
                                    <p class="service-sidebar__contact-text"><i class="fa fa-paper-plane"></i><a href="mailto:<?php echo $email_id; ?>"><?php echo $email_id; ?></a></p><!-- /.service-sidebar__contact-text -->
                    ...
                    <div class="col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__image">
                                <img src="<?php echo $url; ?>/images/services/xcosmetic.jpg.pagespeed.ic.f_-J2G2O-l.jpg" alt="Cosmetic Denstistry" />
                            </div><!-- /.service-details__image -->
                            <h3 class="service-details__title">Cosmetic Dentistry</h3>
                            <hr><!-- /.service-details__title -->
                            <div class="service-details__image-content">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="service-details__image-content__content">
                                            <p class="service-details__tag-line">Cosmetic Dentistry is performed in the followings ways.</p><!-- /.service-details__tag-line -->
                                            <ul class="service-details__list">
                                                <li class="service-details__list-item"><i class="fa fa-angle-right"></i>Aesthetic Fillings</li>
                                                <li class="service-details__list-item"><i class="fa fa-angle-right"></i>Veneers</li>
                                                <li class="service-details__list-item"><i class="fa fa-angle-right"></i>Bleaching</li>
                                                <li class="service-details__list-item"><i class="fa fa-angle-right"></i>Enjoy a Refreshment from our Beverage Station</li>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="faq-content">
                                        <p class="service-details__text"><b>Aesthetic Fillings:</b>

                                            <?php echo $name; ?> not only believes in restoring the function of decayed or broken teeth, but also in providing an aesthetic touch to it. Decayed or fractured teeth give a very unsightly appearance. These teeth can now be restored to the original shade, gloss and anatomy using tooth coloured filling materials. The dentist employs a complex shade selection process in order to give the desired results to the patients. These restorations appear so natural that it becomes almost impossible to differentiate between the natural tooth and the filling material.<br><br>
                                            ...
                                            <br>
                                            Dental bleaching is a simple and very regular cosmetic procedure carried out at <?php echo $name; ?>. This procedure helps get rid of the stains and the yellow texture of teeth. The result is lightening and brightening of the teeth, giving you a younger, more aesthetic and appealing smile.<br><br>

                                            <B>1. How is the bleaching procedure carried out?</B><br>
                                            ...
                                            <b>2. What are the benefits of Dental Bleaching?</b><br>
                                            ...
                                            <br><br><b>
                                                3. Are there any side effects of bleaching?</b><br>

                                            Bleaching of teeth is a safe. The most common side effect is the sensitivity of teeth for a day after the procedure. This sensitivity only occurs in a few patients. This sensitivity can be warded off using commonly available anti-sensitivity toothpaste.<br><br>
                                            <b>
                                                4. What is the care to be taken after the bleaching procedure?</b><br>

                                            The following are the instructions that will be given to you after the bleaching procedure:<br>

                                            a. Not to have any coloured food items like wine, tea, turmeric and coloured curry/gravy for 3 to 4 days. This is because the teeth tend to absorb excessive colouring agents for a few hours after the procedure.<br>

                                            b. Use an anti sensitivity toothpaste for 2 weeks.<br>

                                            c. Avoid anything excessively hot or cold for 2 days. This is again related to the side effect of sensitive teeth after the procedure.
                                            <br><br>
                                            <b>
                                                5. Can Bleaching of teeth be done at home?</b><br>

                                            Yes, Bleaching of teeth can be done at home. Home bleaching kits are available at the clinic. The doctors will personally train the patients to use this kit.<br><br>
