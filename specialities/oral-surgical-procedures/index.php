...
<head>
    ...
    <title><?php echo $title; ?> : Oral Surgical Procedures</title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="inner-banner">
            <div class="container">
                <h2 class="inner-banner__title">Advanced Gum Treatment</h2><!-- /.inner-banner__title -->
                <ul class="thm-breadcrumb">
                    ...
                    <li class="thm-breadcrumb__item current"><a class="thm-breadcrumb__link" href="../../specialities/oral-surgical-procedures/">Oral Surgical Procedures</a></li>
                </ul><!-- /.thm-breadcrumb -->
            </div><!-- /.container -->
                    ...
                    <div class="col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__image">
                                <img src="<?php echo $url; ?>/images/services/maxresdefault.jpg" alt="Awesome Image" />
                            </div><!-- /.service-details__image -->
                            <h3 class="service-details__title">Oral Surgical Procedures</h3><!-- /.service-details__title -->
                            <p class="service-details__text">Patients might have to undergo minor oral surgical procedures at some point or the other in life. <?php echo $name; ?> offers you surgical procedures at the hands of the best Oral Surgeons in Faridabad, Haryana.<br><br>

                                An oral surgery can cure a wide variety of problems relating to the mouth, teeth and facial regions ranging from cosmetic facial surgery to corrective jaw surgery and wisdom tooth removal. We can also diagnose and treat facial pain, facial injuries and dysfunction in the jaw, and perform a full range of dental implant procedures.</p><!-- /.service-details__text -->
