...
<head>
    ...
    <title><?php echo $title; ?> : Children Dentistry</title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="inner-banner">
            <div class="container">
                <h2 class="inner-banner__title">Children Dentistry</h2><!-- /.inner-banner__title -->
                <ul class="thm-breadcrumb">
                    ...
                    <li class="thm-breadcrumb__item current"><a class="thm-breadcrumb__link" href="../../specialities/children-dentistry/">Children Dentistry</a></li>
                </ul><!-- /.thm-breadcrumb -->
            </div><!-- /.container -->
                    ...
                    <div class="col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__image">
                                <img src="<?php echo $url; ?>/images/services/Pediatric-Dentistry.jpg" alt="Children Dentistry" />
                            </div><!-- /.service-details__image -->
                            <h3 class="service-details__title">Children Dentistry</h3><!-- /.service-details__title -->
                            <p class="service-details__text">Start early and save dental trips. Bi annual dental checkups are recommended for the entire family including your tiny tots.<br>

                                The first tooth appears before a child’s first birthday. Ask us how to be dentally aware to prevent early cavities.<br>

                                The first physical check up at the dentist should be completed at least by the age of 6. This is the time when the child is losing his milk teeth and gaining the permanents which are going to last the rest of his life.<br>

                                Persistent Lip/Thumb sucking and/or over retained milk teeth which refuse to shed off as per schedule can lead to crooked, protruded or even absent permanent teeth which may progress to the need for Braces.<br>
