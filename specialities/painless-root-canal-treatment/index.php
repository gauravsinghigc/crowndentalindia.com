...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="inner-banner">
            <div class="container">
                <h2 class="inner-banner__title">Painless Root Canal Treatment</h2><!-- /.inner-banner__title -->
                <ul class="thm-breadcrumb">
                    ...
                    <li class="thm-breadcrumb__item current"><a class="thm-breadcrumb__link" href="../../specialities/painless-root-canal-treatment/">Painless Root Canal Treatment</a></li>
                </ul><!-- /.thm-breadcrumb -->
            </div><!-- /.container -->
                    ...
                    <div class="col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__image">
                                <img src="<?php echo $url; ?>/images/services/Root-Canal.png" alt="painless-root-canal-treatment" title="painless-root-canal-treatment" />
                            </div><!-- /.service-details__image -->
                            <h3 class="service-details__title">Painless Root Canal Treatment</h3><!-- /.service-details__title -->
                            <p class="service-details__text">Root canal treatment is required when the blood or the nerve supply (Known as the pulp) of the tooth gets infected, mostly due to the external decay of the tooth. This can lead to a further infection of the surrounding areas of the tooth. The pulp of the tooth runs in the form of a fine canal system in the roots of the tooth. Infected Pulp is not repairable by the body, thus requiring its removal in case of an infection. This removal is followed by replacing the site previously occupied by the pulp, with a suitable filling material.<br><br> Root Canal Treatments are essentially painless. The procedure is carried out under Local Anaesthesia which makes sure that the procedure is absolutely comfortable to the patient.</p><!-- /.service-details__text -->
                            <br><br>
                            <a href="../../booking/" class="topbar-one__btn">Book an Appointment</a>
