...
<head>
    ...
    <title><?php echo $title; ?> : Awards & Recognition</title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="inner-banner">
            <div class="container">
                <h2 class="inner-banner__title">Awards and Recognitions</h2><!-- /.inner-banner__title -->
                <ul class="thm-breadcrumb">
                    <li class="thm-breadcrumb__item"><a class="thm-breadcrumb__link" href="../">Home</a></li>
                    <li class="thm-breadcrumb__item current"><a class="thm-breadcrumb__link" href="../awards-and-recognitions/">Awards and Recognitions</a></li>
                </ul><!-- /.thm-breadcrumb -->
            </div><!-- /.container -->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="gallery-one__single">
                            <div class="gallery-one__image">
                                <img src="<?php echo $url; ?>/img/cert/icd award.jpg" alt="Awesome Image" />
                            </div><!-- /.gallery-one__image -->
                            <div class="gallery-one__content">
                                <a href="<?php echo $url; ?>/img/cert/icd award.jpg" class="gallery-one__popup img-popup"><i class="icon icon-Search"></i></a>
                                <div class="gallery-one__bottom">
                                    <h3 class="gallery-one__text"><?php echo $dr; ?> @ ICD Award</h3><!-- /.gallery-one__text -->
                    ...
                    <div class="col-lg-7">
                        <div class="gallery-one__single">
                            <div class="gallery-one__image">
                                <img src="<?php echo $url; ?>/img/FB_IMG_1517282652185.jpg" alt="Awesome Image" />
                            </div><!-- /.gallery-one__image -->
                            <div class="gallery-one__content">
                                <a href="<?php echo $url; ?>/img/FB_IMG_1517282652185.jpg" class="gallery-one__popup img-popup"><i class="icon icon-Search"></i></a>
                                <div class="gallery-one__bottom">
                                    <h3 class="gallery-one__text"> <?php echo $dr; ?>@ OneZoe First Aid</h3><!-- /.gallery-one__text -->
                                </div><!-- /.gallery-one__bottom -->
                            </div><!-- /.gallery-one__content -->
                        </div><!-- /.gallery-one__single -->
                    </div><!-- /.col-lg-4 -->
