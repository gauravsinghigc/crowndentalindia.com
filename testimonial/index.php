                            ...
                            <div class="col-lg-4">
                                <div class="gallery-one__single">
                                    <div class="gallery-one__image">
                                        <img src="<?php echo $url; ?>/img/test/<?php echo $file; ?>" alt="<?php echo $name; ?>" />
                                    </div><!-- /.gallery-one__image -->
                                    <div class="gallery-one__content">
                                        <a href="<?php echo $url; ?>/img/test/<?php echo $file; ?>" class="gallery-one__popup img-popup"><i class="icon icon-Search"></i></a>
